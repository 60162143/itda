...
<img width="300" height="600" alt="로그인 화면" src="https://github.com/60162143/itda/assets/33407087/e6f0263a-90e6-44e9-a332-bde8da0e009c" /> &nbsp;&nbsp;&nbsp;&nbsp; <img width="300" height="600" alt="회원가입 화면" src="https://github.com/60162143/itda/assets/33407087/c579eeae-1aee-4485-9833-280f4d078933" />
  ...
  - [Gmail SMTP](#1-사용-라이브러리) 방식을 이용한 인증 메일 전송 기능 구현
...
### **3. 가게 상세 화면**
  - #### **1. 가게 정보 조회 화면**
    ...
    - 가게 정보 **조회 기능** 구현( **가게 정보 데이터는 [카카오 맵에서 크롤링](https://github.com/60162143/itda-data-Crawling)** )

    - **[카카오맵 API 라이브러리](#1-사용-라이브러리)를 이용한 가게 위치 조회 기능** 구현
    - 협업된 가게 정보 **조회 기능** 구현
    - 가게 찜 기능 구현
    - 리뷰 **조회 기능** 구현
...
<br />
  ...
  - #### **2. 리뷰 화면**
    ...
    - 리뷰 작성 시 사진 **업로드 기능** 구현 ( **[ftp4j-1.6 라이브러리](#1-사용-라이브러리)를 이용한 ftp 파일 업로드** )
    - 작성된 리뷰에 댓글 작성 기능 구현
...
<br />
  ...
  - #### **3. 주문 결제 화면**
    ...
    - [Boot Pay 라이브러리](#1-사용-라이브러리)를 이용한 결제 기능 구현 ( 카카오 결제 or 카드 결제 )
    - 결제 시 쿠폰 사용 기능 구현
...
<img width="300" height="600" alt="지도 화면" src="https://github.com/60162143/itda/assets/33407087/d9a54d75-6e1d-4fb6-8e02-693028373a8e" />
  ...
  - [카카오 지도 API](#2-사용-api)를 이용한 지도 화면 구현
