...
public class InfoReviewRvAdapter extends RecyclerView.Adapter<InfoReviewRvAdapter.CustomInfoReviewViewHolder> implements onInfoReviewPhotoRvClickListener{
    ...
    public void onBindViewHolder(@NonNull CustomInfoReviewViewHolder holder, int position) {
        ...
        InfoReviewPhotoRvAdapter infoReviewPhotoAdapter = new InfoReviewPhotoRvAdapter(mContext, this, reviewPhoto);  // 리사이클러뷰 어뎁터 객체 생성

        holder.reviewPhotoRv.setLayoutManager(new LinearLayoutManager(mContext, RecyclerView.HORIZONTAL, false));
        holder.reviewPhotoRv.setAdapter(infoReviewPhotoAdapter);
    }
