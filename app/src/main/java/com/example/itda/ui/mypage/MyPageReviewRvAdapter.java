...
public class MyPageReviewRvAdapter extends RecyclerView.Adapter<MyPageReviewRvAdapter.CustomInfoReviewViewHolder>
    ...
    // Constructor
    public MyPageReviewRvAdapter(Context context
            , ArrayList<infoReviewData> reviews
            , ArrayList<infoPhotoData> Photos
            , String storeName
            , onMyPageReviewRvClickListener clickListener){
    ...
    public CustomInfoReviewViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        return new CustomInfoReviewViewHolder(view);
    }
    ...
    public static class CustomInfoReviewViewHolder extends RecyclerView.ViewHolder {
        ...
        public CustomInfoReviewViewHolder(@NonNull View itemView) {
            ...
            reviewBtnLayout = itemView.findViewById(R.id.info_review_btn_layout);

            reviewBtnLayout.setVisibility(View.GONE);
            ...
            itemView.setOnClickListener(view -> {
                ...
                if(pos != RecyclerView.NO_POSITION){
                    rvClickListener.onMyPageReviewRvClick(view, getAbsoluteAdapterPosition(), "total");
                }
            });
