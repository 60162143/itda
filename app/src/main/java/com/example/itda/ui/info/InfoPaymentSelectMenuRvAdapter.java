...
public class InfoPaymentSelectMenuRvAdapter extends RecyclerView.Adapter<InfoPaymentSelectMenuRvAdapter.CustomInfoMenuViewHolder> {
    ...
    @NonNull
    @Override
    public InfoPaymentSelectMenuRvAdapter.CustomInfoMenuViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        // layoutInflater로 xml객체화. viewHolder 생성
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.rv_info_payment_select_menu, parent, false);

        return new InfoPaymentSelectMenuRvAdapter.CustomInfoMenuViewHolder(view);
    }
    ...
    public static class CustomInfoMenuViewHolder extends RecyclerView.ViewHolder {
        ...
        public CustomInfoMenuViewHolder(@NonNull View itemView) {
            ...
            infoSelectMenuName = itemView.findViewById(R.id.info_payment_select_menu_name);
            infoSelectMenuPrice = itemView.findViewById(R.id.info_payment_select_menu_price);
            infoSelectMenuCount = itemView.findViewById(R.id.info_payment_select_menu_count);
            infoSelectMenuMinus = itemView.findViewById(R.id.info_payment_select_menu_minus);
            infoSelectMenuPlus = itemView.findViewById(R.id.info_payment_select_menu_plus);
            ...
            infoSelectMenuMinus.setOnClickListener(view -> {
                ...
                if(pos != RecyclerView.NO_POSITION){
                    rvClickListener.onInfoPaymentSelectMenuRvClick(view, getAbsoluteAdapterPosition(), "minus");
                }
            });
            ...
            infoSelectMenuPlus.setOnClickListener(view -> {
                ...
                // 리스너 객체를 가진 Activity에 오버라이딩 된 클릭 함수 호출
                if(pos != RecyclerView.NO_POSITION){
                    rvClickListener.onInfoPaymentSelectMenuRvClick(view, getAbsoluteAdapterPosition(), "plus");
                }
            });
        }
    }
