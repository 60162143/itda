...
public class InfoPhotoTotalRvAdapter extends RecyclerView.Adapter<InfoPhotoTotalRvAdapter.CustomInfoPhotoTotalViewHolder>{
    ...
    @NonNull
    @Override
    public CustomInfoPhotoTotalViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        return new InfoPhotoTotalRvAdapter.CustomInfoPhotoTotalViewHolder(view);
    }
